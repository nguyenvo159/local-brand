                ...
                ?>        
                    ...
                    <div class="col-10 p-0 offset-1 border-bottom">
                        <div class="card rounded-0 mt-3 flex-row">
                            <div class="p-2 card-body position-relative">
                                ...
                                <p><b>Người đặt:</b> <i><?= htmlspecialchars($order->getName())?></i></p> 
                                <p><b>Số điện thoại:</b> <i><?= htmlspecialchars($order->getPhone())?></i></p> 
                    ...
                    <div class="col-10 offset-1 p-0 d-flex justify-content-center">
                        ...
                        <!-- Các oderDetail -->
                            ...
                            ?>              
                                <div class="card mt-3 flex-row " data-product-id="<?=htmlspecialchars($product->getId())?>">
